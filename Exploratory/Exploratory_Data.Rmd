...
# value 0 to all Na if numeric field
TotData<- Tot_no_null%>%mutate_if(is.numeric, funs(replace_na(., 0)))
...
save(AggTotData, file = paste(datapath,file_Aggtotdata_save,sep=""))
```