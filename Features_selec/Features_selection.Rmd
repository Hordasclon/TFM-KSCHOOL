...
#### This RMarkdown tries to  find correlations between features to select the best group for the goal of this project
...
#### Complete NA values, we will use predictive mean matching (pmm) (multi nominal logistic regression)
