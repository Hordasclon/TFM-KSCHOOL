...
#install.packages("utils") .- Several R utilities
...
#install.packages("R.utils").- To get several functions like isZero 
...
```{r Generate_AQI_png_maps,include=FALSE,results = FALSE, eval=FALSE}
#, eval=FALSE
...
```{r AQI_Maps_read, include=FALSE, results = FALSE, eval=FALSE}
#, eval=FALSE
...
```{r AQI_Maps_animate, include=FALSE, results = FALSE, eval=FALSE}
#, eval=FALSE
...
```{r AQI_Maps_show, include=FALSE, results = FALSE, eval=FALSE}
#, eval=FALSE
