---
title: "1_TFM_Health_In_Air-DataCleaning"
...
#install.packages("tidyverse") .- para el uso de tibbless
...
## Realizamos las llamadas a las librerías instaladas:
...
```
----------------------------------------------------------------------------------
## Nuevo set de Datos, Visitas al Hospital por afecciones respiratorias:
   Se trata de un informe en excel con mismo formato para todos los estados y cada uno de ellos separado en una hoja distinta
----------------------------------------------------------------------------------
```{r Visits_load}
...
# Generamos un mapa por año mes con los datos de calidad de aire de cada condado
