...
save(Air_Quality_Indexes, file = paste(datapath,"Air_Quality_Indexes.Rdata"))
```
...
save(Hospital_Visits_by_State, file = paste(datapath,"Hospital_Visits_by_State.Rdata"))
